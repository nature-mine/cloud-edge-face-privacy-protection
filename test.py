...
def vis_parsing_maps(im, parsing_anno, stride, save_im=False, save_path='vis_results/parsing_map_on_im.jpg'):
    ...
    vis_parsing_anno = np.where(np.isin(vis_parsing_anno, list(CORE_FACE_PART_CLASSES)), vis_parsing_anno, 0).astype(np.uint8)
    vis_parsing_anno_color = cv2.cvtColor(vis_im, cv2.COLOR_RGB2BGR)
